...
[0] = LAYOUT_60_ansi_tsangan_split_rshift(
                ...
                KC_LCTL,   KC_LGUI, KC_LALT,                            KC_SPC,                   LM(2, MOD_LGUI), LM(2, MOD_LGUI | MOD_LSFT), MT(MOD_RCTL, KC_RIGHT)),
...
[2] = LAYOUT_60_ansi_tsangan_split_rshift(
                ...
                KC_TRNS, KC_PGUP, KC_UP,   KC_PGDN, KC_HOME, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_MODE_FORWARD, RGB_MODE_REVERSE, KC_TRNS,
